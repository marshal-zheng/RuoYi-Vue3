...
export function getProject(projectId) {
  return request({
    url: '/protocol/project/' + projectId,
    method: 'get'
  })
}
...
export function listProjectConfig(query) {
  return request({
    url: '/protocol/project/config/list',
    method: 'get',
    params: query
  })
}
...
export function getProjectConfig(configId) {
  return request({
    url: '/protocol/project/config/' + configId,
    method: 'get'
  })
}
...
export function exportProjectConfig(query) {
  return request({
    url: '/protocol/project/config/export',
    method: 'post',
    data: query
  })
}